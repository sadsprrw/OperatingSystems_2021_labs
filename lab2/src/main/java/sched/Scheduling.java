    ...
    try {   
      ...
      while ((line = in.readLine()) != null) {
        ...
        if (line.startsWith("process")) {
          ...
          processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0,(int)(Math.random() * 9 + 1), processVector.size()));
        }
  ...
  public static void main(String[] args) {
    ...
    if (processVector.size() < processnum) {
      ...
      while (processVector.size() < processnum) {       
        ...
        processVector.addElement(new sProcess(cputime,i*100,0,0,0, (int)(Math.random() * 9 + 1), processVector.size()));
        i++;
      }
    }
